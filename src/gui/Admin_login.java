...
public class Admin_login extends javax.swing.JFrame {
     ...
     */
    public Admin_login() throws FileNotFoundException {
        initComponents();
        readFile();
    }
    private void readFile() throws FileNotFoundException
    {
        ...
        while(s.hasNextLine())
        {
            ...
            u[count]= new Users(tokens[0],tokens[1]);
            count++;
        }
    }
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!found)
        {
            JOptionPane.showMessageDialog(this,"this username or password doesn't exist");
        }
